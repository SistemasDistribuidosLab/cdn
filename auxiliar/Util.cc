...
// int UTIL::prefixLen(int *key, NodeEntry *n2) {
...
// bool UTIL::startWith(int *k, char c) {
...
// string UTIL::truncateNodeId(int *k) {
//     if (k == NULL)
//         return "  null ";
...
// const char *UTIL::myBN2HEX2(int *k)
...
// const char *UTIL::myBN2HEX(int *k)
...
// bool UTIL::hasDigitAt(int *b, int pos, char c) {
//     const char *s = UTIL::myBN2HEX(b);
